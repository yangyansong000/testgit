...
;*
;* Project      : HT6xxx
;* File         : startup_ht633x.s
;* By           : SDTeam
;* Version      : Version1_0_20211103
;* Description  :
;*********************************************************************************************************
;*/
...
__vector_table
        ...
        DCD     EXTI7_9_IRQHandler        ; 16+28: EXTI7、EXTI8、EXTI9
        DCD     Reserved_IRQHandler       ; 16+29: Reserved
        DCD     SPI2_IRQHandler           ; 16+30: SPI2
        DCD     DMA_IRQHandler            ; 16+31: DMA
		DCD     LPUART_IRQHandler         ; 16+32: LPUART
		DCD     EXTI10_14_IRQHandler      ; 16+33: EXTI10、EXTI11、EXTI12、EXTI13、EXTI14
		DCD     EWKUP_IRQHandler          ; 16+34: EWKUP
		DCD     SPI3_IRQHandler           ; 16+35: SPI3
...
LPUART_IRQHandler
        ...
        PUBWEAK EXTI10_14_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
EXTI10_14_IRQHandler
        B EXTI10_14_IRQHandler

        PUBWEAK EWKUP_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
EWKUP_IRQHandler
        B EWKUP_IRQHandler
