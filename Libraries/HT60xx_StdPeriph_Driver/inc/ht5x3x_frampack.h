...
#ifndef __HT5X3X_FRAMPACK_H__
#define __HT5X3X_FRAMPACK_H__
...
#define FRAMPACK_SPISEL_SPI1        ((uint32_t)FRAMPACK_FRAMCON_SPISEL_SPI1)
...
typedef enum
{
  PACK_Sel_SPI1 = FRAMPACK_SPISEL_SPI1, 
...
typedef struct  __FRAMPACK_InitTypeDef
{
    ...
    PACK_ChnNum_TypeDef       Chn_Number;     /*!< FRAMPACK data out put channel number 1/2/3 */
    ...
    PACK_CLEN_TypeDef        CRC_Length;      /*!< FRAMPACK CRC Select CRC/CHECKSUM     */
...
*/
typedef  void (*pFRAMPACK_CallbackTypeDef)(FRAMPACK_InitTypeDef *FRAMPACK_InitStruct);  /*!< pointer to an EMUIF callback function */

#endif

#define IS_HT_FRAMPACK_SPI_SELECT(select)      (((select) == FRAMPACK_SPISEL_SPI1) || ((select) == FRAMPACK_SPISEL_SPI2))
#define IS_HT_FRAMPACK_DATA_ENDIAN(endian)     (((endian) == FRAMPACK_ENDIAN_SMALL) || ((endian) == FRAMPACK_ENDIAN_BIG))
#define IS_HT_FRAMPACK_CHN_NUMBER(chnnum)      (((chnnum) == FRAMPACK_CHNNUM_1) || ((chnnum) == FRAMPACK_CHNNUM_2) || ((chnnum) == FRAMPACK_CHNNUM_3))
