...
*                                                   @arg PACK_BitWide_16bits (FRAMPACK_BITWIDE_24BITS)
*                                                   @arg PACK_BitWide_24bits (FRAMPACK_BITWIDE_16BITS)
...
StatusTypeDef HT_FRAMPACK_Init(FRAMPACK_InitTypeDef *FRAMPACK_InitStruct)
{
	...
	else
	{
		...
		assert_param(IS_HT_FRAMPACK_CRC_LENGTH(FRAMPACK_InitStruct->CRC_Length));
		...
		HT_FRAMPACK->FCRCCFG = ((FRAMPACK_InitStruct->CRC_Select	&	FRAMPACK_FCRCCFG_CRCSEL_Mask) 	|\
                                ...
                                (FRAMPACK_InitStruct->CRC_Length	&	FRAMPACK_FCRCCFG_CLEN_SEL_Mask) |\
...
*
* @param:   ITFlag     FRAMPACK interrupt flag check, it can be the following parameters:
